...
const amountOfUsers = parseInt(args[0]);
const domainName = args[1];

if (!amountOfUsers || !domainName || amountOfUsers > 500 || amountOfUsers < 1) {
  console.error("Usage: ts-node seed.users.script.ts <amountOfUsers> <domainName>");
